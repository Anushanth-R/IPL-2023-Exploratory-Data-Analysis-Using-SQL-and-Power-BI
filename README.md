# IPL 2023 – Exploratory Data Analysis Using SQL and Power BI
## Introduction
...
## Abstract
In this cricket analytics project titled ‘IPL 2023 – Exploratory Data Analysis Using SQL and Power BI’, I have used ball-by-ball data sourced from Kaggle, with due credit to its creator. Workflow includes data extraction using SQL, transformation, and visualization in Power BI Desktop. Through SQL, I extract and refine relevant data, creating a structured dataset for analytics. Using Power BI Desktop, established connections and generate preliminary visual insights, acknowledging that design and image quality require future improvement. Will also provide sample SQL queries as a reference for in-depth analysis. I will share the Power BI file for easy access and encourage users to zoom in for a detailed view, recommending bigger screens for comprehensive exploration.
